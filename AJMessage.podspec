#
# Be sure to run `pod lib lint AJMessage.podspec' to ensure this is a
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = 'Show simple message easily'

  s.homepage         = 'https://github.com/ajijoyo/AJMessage'
